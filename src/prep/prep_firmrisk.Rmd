...
```{r echo = FALSE}
fq <- readRDS("data/format/firmquarter_2020q4.rds")
```

The output data file `firmquarter_2020q4.rds` contains `r format(nrow(fq),big.mark = ",")` rows of data corresponding to `r format(length(unique(fq$company_name)),big.mark = ",")` companies.
